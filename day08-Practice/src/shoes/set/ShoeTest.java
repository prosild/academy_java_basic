...
public class ShoeTest {
	...
	public static void main(String[] args) {
	    ...
	    */
		...
		ShoeSet shoeSet = new ShoeSet(shoes);
		
		// 3. 각 자료구조별 shoes 를 foreach 로 출력
		System.out.println("3. --------------------------------------------------------------------------------------------------------------");
		for (Shoe shoe : shoeSet.getAllShoes()) {
