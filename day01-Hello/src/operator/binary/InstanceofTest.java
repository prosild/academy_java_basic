...
public class InstanceofTest {
	...
	public static void main(String[] args) {
		...
		System.out.printf("name = %s이며%n%s(은)는 String 타입인가? %b%n", name, name, result);
		...
		// 2. 초기화
		surname = new StringBuffer("Park");
		
		// 3. 사용
		result = ((Object)surname instanceof String);
		System.out.printf("surname = %s이며%n%s(은)는 String 타입인가? %b%n", surname, surname, result);
	}
